...
using s = Starcounter;
using __DaAddPetTr__ = global::KitchenSink.DatagridPage.Input.AddPetTrigger;
...
public partial class DatagridPage : __Json__ {
    ...
    public static class JsonByExample {
        ...
        public class Schema : __TObject__ {
            public Schema()
                ...
                AddPetTrigger.SetCustomAccessors((_p_) => { return ((__Datagrid__)_p_).__bf__AddPetTrigger__; }, (_p_, _v_) => { ((__Datagrid__)_p_).__bf__AddPetTrigger__ = (System.Int64)_v_; }, false);
                AddPetTrigger.AddHandler((Json pup, Property<Int64> prop, Int64 value) => { return (new Input.AddPetTrigger() { App = (DatagridPage)pup, Template = (TLong)prop, Value = value }); }, (Json pup, Starcounter.Input<Int64> input) => { ((DatagridPage)pup).Handle((Input.AddPetTrigger)input); });
            }
    ...
    public static class Input {
        ...
        #line hidden
        public class AddPetTrigger : Input<__Datagrid__, __TLong__, long> {
        }
        #line default
    }
    #line default
