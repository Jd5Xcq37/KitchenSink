...
using __FFiDeleteTr__ = global::KitchenSink.FileUploadPage.FileUploadFilePage.Input.DeleteTrigger;
...
public partial class FileUploadPage : __Json__ {
    ...
    public partial class FileUploadFilePage : __Json__ {
        ...
        public static class JsonByExample {
            ...
            public class Schema : __TObject__ {
                public Schema()
                    ...
                    DeleteTrigger = Add<__TLong__>("DeleteTrigger$");
                    DeleteTrigger.DefaultValue = 0L;
                    DeleteTrigger.Editable = true;
                    DeleteTrigger.SetCustomAccessors((_p_) => { return ((__FiFileUplo__)_p_).__bf__DeleteTrigger__; }, (_p_, _v_) => { ((__FiFileUplo__)_p_).__bf__DeleteTrigger__ = (System.Int64)_v_; }, false);
                    DeleteTrigger.AddHandler((Json pup, Property<Int64> prop, Int64 value) => { return (new Input.DeleteTrigger() { App = (FileUploadFilePage)pup, Template = (TLong)prop, Value = value }); }, (Json pup, Starcounter.Input<Int64> input) => { ((FileUploadFilePage)pup).Handle((Input.DeleteTrigger)input); });
                }
                ...
                public __TLong__ DeleteTrigger;
            }
            #line default
        }
        #line default
        ...
        #line 10 "FileUploadPage.json"
            ...
            #line default
        #line hidden
        private System.Int64 __bf__DeleteTrigger__;
        #line default
        [_GEN1_][_GEN2_("Starcounter","2.0")]
        public System.Int64 DeleteTrigger {
        #line 11 "FileUploadPage.json"
            get {
            #line hidden
                return Template.DeleteTrigger.Getter(this); }
            #line 11 "FileUploadPage.json"
            set {
            #line hidden
                Template.DeleteTrigger.Setter(this, value); } }
            #line default
        ...
        public static class Input {
            ...
            #line hidden
            public class DeleteTrigger : Input<__FiFileUplo__, __TLong__, long> {
            }
            #line default
        }
        #line default
