...
using __GeResetTri__ = global::KitchenSink.GeoPagePosition.Input.ResetTrigger;
...
public partial class GeoPagePosition : __Json__ {
    ...
    public static class JsonByExample {
        ...
        public class Schema : __TObject__ {
            public Schema()
                ...
                ResetTrigger = Add<__TLong__>("ResetTrigger$");
                ResetTrigger.DefaultValue = 0L;
                ResetTrigger.Editable = true;
                ResetTrigger.SetCustomAccessors((_p_) => { return ((__GeoPageP__)_p_).__bf__ResetTrigger__; }, (_p_, _v_) => { ((__GeoPageP__)_p_).__bf__ResetTrigger__ = (System.Int64)_v_; }, false);
                ResetTrigger.AddHandler((Json pup, Property<Int64> prop, Int64 value) => { return (new Input.ResetTrigger() { App = (GeoPagePosition)pup, Template = (TLong)prop, Value = value }); }, (Json pup, Starcounter.Input<Int64> input) => { ((GeoPagePosition)pup).Handle((Input.ResetTrigger)input); });
            }
    ...
    #line 6 "GeoPage.json"
        ...
        #line default
    #line hidden
    private System.Int64 __bf__ResetTrigger__;
    #line default
    [_GEN1_][_GEN2_("Starcounter","2.0")]
    public System.Int64 ResetTrigger {
    #line 7 "GeoPage.json"
        get {
        #line hidden
            return Template.ResetTrigger.Getter(this); }
        #line 7 "GeoPage.json"
        set {
        #line hidden
            Template.ResetTrigger.Setter(this, value); } }
        #line default
    ...
    public static class Input {
        ...
        #line hidden
        public class ResetTrigger : Input<__GeoPageP__, __TLong__, long> {
        }
        #line default
    }
    #line default
