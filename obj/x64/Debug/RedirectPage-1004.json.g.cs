...
using __ReGoToDocs__ = global::KitchenSink.RedirectPage.Input.GoToDocsTrigger;
using __ReMorphUrl__ = global::KitchenSink.RedirectPage.Input.MorphUrl;
using __ReGoToHome__ = global::KitchenSink.RedirectPage.Input.GoToHomePartialTrigger;
...
public partial class RedirectPage : __Json__ {
    ...
    public static class JsonByExample {
        ...
        public class Schema : __TObject__ {
            public Schema()
                ...
                GoToHomePartialTrigger = Add<__TLong__>("GoToHomePartialTrigger$");
                GoToHomePartialTrigger.DefaultValue = 0L;
                GoToHomePartialTrigger.Editable = true;
                GoToHomePartialTrigger.SetCustomAccessors((_p_) => { return ((__Redirect__)_p_).__bf__GoToHomePartialTrigger__; }, (_p_, _v_) => { ((__Redirect__)_p_).__bf__GoToHomePartialTrigger__ = (System.Int64)_v_; }, false);
                GoToHomePartialTrigger.AddHandler((Json pup, Property<Int64> prop, Int64 value) => { return (new Input.GoToHomePartialTrigger() { App = (RedirectPage)pup, Template = (TLong)prop, Value = value }); }, (Json pup, Starcounter.Input<Int64> input) => { ((RedirectPage)pup).Handle((Input.GoToHomePartialTrigger)input); });
                ...
                GoToDocsTrigger = Add<__TLong__>("GoToDocsTrigger$");
                GoToDocsTrigger.DefaultValue = 0L;
                GoToDocsTrigger.Editable = true;
                GoToDocsTrigger.SetCustomAccessors((_p_) => { return ((__Redirect__)_p_).__bf__GoToDocsTrigger__; }, (_p_, _v_) => { ((__Redirect__)_p_).__bf__GoToDocsTrigger__ = (System.Int64)_v_; }, false);
                GoToDocsTrigger.AddHandler((Json pup, Property<Int64> prop, Int64 value) => { return (new Input.GoToDocsTrigger() { App = (RedirectPage)pup, Template = (TLong)prop, Value = value }); }, (Json pup, Starcounter.Input<Int64> input) => { ((RedirectPage)pup).Handle((Input.GoToDocsTrigger)input); });
            ...
            public __TLong__ GoToHomePartialTrigger;
            public __TString__ MorphUrl;
            public __TLong__ GoToDocsTrigger;
    ...
    #line 5 "RedirectPage.json"
        ...
        #line default
    #line hidden
    private System.Int64 __bf__GoToHomePartialTrigger__;
    #line default
    [_GEN1_][_GEN2_("Starcounter","2.0")]
    public System.Int64 GoToHomePartialTrigger {
    #line 6 "RedirectPage.json"
        get {
        #line hidden
            return Template.GoToHomePartialTrigger.Getter(this); }
        #line 6 "RedirectPage.json"
        set {
        #line hidden
            Template.GoToHomePartialTrigger.Setter(this, value); } }
        #line default
    #line hidden
    ...
    #line 7 "RedirectPage.json"
        ...
        #line default
    #line hidden
    private System.Int64 __bf__GoToDocsTrigger__;
    #line default
    [_GEN1_][_GEN2_("Starcounter","2.0")]
    public System.Int64 GoToDocsTrigger {
    #line 9 "RedirectPage.json"
        get {
        #line hidden
            return Template.GoToDocsTrigger.Getter(this); }
        #line 9 "RedirectPage.json"
        set {
        #line hidden
            Template.GoToDocsTrigger.Setter(this, value); } }
        #line default
    #line hidden
    ...
    public static class Input {
        ...
        #line hidden
        public class GoToHomePartialTrigger : Input<__Redirect__, __TLong__, long> {
        }
        #line default
        ...
        #line hidden
        public class GoToDocsTrigger : Input<__Redirect__, __TLong__, long> {
        }
        #line default
