...
using __VaValidate__ = global::KitchenSink.ValidationPage.Input.ValidateTrigger;
...
public partial class ValidationPage : __Json__ {
    ...
    public static class JsonByExample {
        ...
        public class Schema : __TObject__ {
            public Schema()
                ...
                ValidateTrigger = Add<__TLong__>("ValidateTrigger$");
                ValidateTrigger.DefaultValue = 0L;
                ValidateTrigger.Editable = true;
                ValidateTrigger.SetCustomAccessors((_p_) => { return ((__Validati__)_p_).__bf__ValidateTrigger__; }, (_p_, _v_) => { ((__Validati__)_p_).__bf__ValidateTrigger__ = (System.Int64)_v_; }, false);
                ValidateTrigger.AddHandler((Json pup, Property<Int64> prop, Int64 value) => { return (new Input.ValidateTrigger() { App = (ValidationPage)pup, Template = (TLong)prop, Value = value }); }, (Json pup, Starcounter.Input<Int64> input) => { ((ValidationPage)pup).Handle((Input.ValidateTrigger)input); });
            ...
            public __TLong__ ValidateTrigger;
    ...
    #line 2 "ValidationPage.json"
        ...
        #line default
    #line hidden
    private System.Int64 __bf__ValidateTrigger__;
    #line default
    [_GEN1_][_GEN2_("Starcounter","2.0")]
    public System.Int64 ValidateTrigger {
    #line 3 "ValidationPage.json"
        get {
        #line hidden
            return Template.ValidateTrigger.Getter(this); }
        #line 3 "ValidationPage.json"
        set {
        #line hidden
            Template.ValidateTrigger.Setter(this, value); } }
        #line default
    #line hidden
    ...
    public static class Input {
        ...
        #line hidden
        public class ValidateTrigger : Input<__Validati__, __TLong__, long> {
        }
        #line default
