...
using s = Starcounter;
using __TaAddPetTr__ = global::KitchenSink.TablePage.Input.AddPetTrigger;
...
public partial class TablePage : __Json__ {
    ...
    public static class JsonByExample {
        ...
        public class Schema : __TObject__ {
            public Schema()
                ...
                AddPetTrigger = Add<__TLong__>("AddPetTrigger$");
                AddPetTrigger.DefaultValue = 0L;
                AddPetTrigger.Editable = true;
                AddPetTrigger.SetCustomAccessors((_p_) => { return ((__TablePag__)_p_).__bf__AddPetTrigger__; }, (_p_, _v_) => { ((__TablePag__)_p_).__bf__AddPetTrigger__ = (System.Int64)_v_; }, false);
                AddPetTrigger.AddHandler((Json pup, Property<Int64> prop, Int64 value) => { return (new Input.AddPetTrigger() { App = (TablePage)pup, Template = (TLong)prop, Value = value }); }, (Json pup, Starcounter.Input<Int64> input) => { ((TablePage)pup).Handle((Input.AddPetTrigger)input); });
            }
            public override object CreateInstance(s.Json parent) { return new __TablePag__(this) { Parent = parent }; }
            public __TString__ Html;
            public __TArray__ Pets;
            public __TLong__ AddPetTrigger;
        }
        #line default
    }
    #line default
    ...
    #line 4 "TablePage.json"
        ...
        #line default
    #line hidden
    private System.Int64 __bf__AddPetTrigger__;
    #line default
    [_GEN1_][_GEN2_("Starcounter","2.0")]
    public System.Int64 AddPetTrigger {
    #line 11 "TablePage.json"
        get {
        #line hidden
            return Template.AddPetTrigger.Getter(this); }
        #line 11 "TablePage.json"
        set {
        #line hidden
            Template.AddPetTrigger.Setter(this, value); } }
        #line default
    ...
    public static class Input {
        ...
        #line hidden
        public class AddPetTrigger : Input<__TablePag__, __TLong__, long> {
        }
        #line default
    }
    #line default
