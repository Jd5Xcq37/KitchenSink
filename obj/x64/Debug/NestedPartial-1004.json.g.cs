...
using s = Starcounter;
using __NeAddChild__ = global::KitchenSink.NestedPartial.Input.AddChildTrigger;
...
public partial class NestedPartial : __Json__ {
    ...
    public static class JsonByExample {
        ...
        public class Schema : __TObject__ {
            public Schema()
                ...
                AddChildTrigger = Add<__TLong__>("AddChildTrigger$");
                AddChildTrigger.DefaultValue = 0L;
                AddChildTrigger.Editable = true;
                AddChildTrigger.SetCustomAccessors((_p_) => { return ((__NestedPa__)_p_).__bf__AddChildTrigger__; }, (_p_, _v_) => { ((__NestedPa__)_p_).__bf__AddChildTrigger__ = (System.Int64)_v_; }, false);
                AddChildTrigger.AddHandler((Json pup, Property<Int64> prop, Int64 value) => { return (new Input.AddChildTrigger() { App = (NestedPartial)pup, Template = (TLong)prop, Value = value }); }, (Json pup, Starcounter.Input<Int64> input) => { ((NestedPartial)pup).Handle((Input.AddChildTrigger)input); });
            }
            ...
            public __TLong__ AddChildTrigger;
        }
        #line default
    }
    #line default
    ...
    #line 4 "NestedPartial.json"
        ...
        #line default
    #line hidden
    private System.Int64 __bf__AddChildTrigger__;
    #line default
    [_GEN1_][_GEN2_("Starcounter","2.0")]
    public System.Int64 AddChildTrigger {
    #line 5 "NestedPartial.json"
        get {
        #line hidden
            return Template.AddChildTrigger.Getter(this); }
        #line 5 "NestedPartial.json"
        set {
        #line hidden
            Template.AddChildTrigger.Setter(this, value); } }
        #line default
    ...
    public static class Input {
        ...
        #line hidden
        public class AddChildTrigger : Input<__NestedPa__, __TLong__, long> {
        }
        #line default
    }
    #line default
